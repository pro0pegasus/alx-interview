...
where <total size> is the sum of all prev <file size>
...
the status codes should be printed in ascending order
...
total_size = 0
count = 0  # keeps count of the number lines counted
...
try:
    for line in sys.stdin:
        ...
        if len(line_list) > 4:
            ...
            # check if the status code receives exists in the dictionary and
            # increment its count
